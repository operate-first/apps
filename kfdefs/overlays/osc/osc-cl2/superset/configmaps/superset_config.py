...
OAUTH_PROVIDERS = [
    {'name': 'dex',
     ...
     'remote_app': {
         ...
         'api_base_url': 'http://dex-dex.apps.odh-cl2.apps.os-climate.org/userinfo',
         'access_token_url': 'http://dex-dex.apps.odh-cl2.apps.os-climate.org/token',
         'authorize_url': 'http://dex-dex.apps.odh-cl2.apps.os-climate.org/auth'
     }
     }
]
